      ...
      <div className="container mx-auto max-w-7xl px-3 sm:px-6 py-6 sm:py-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 lg:gap-6 mb-6 lg:mb-8">
          ...
          <div className="bg-white/80 backdrop-blur-sm border-2 border-rose-200 rounded-xl p-4 sm:p-6 transition-all duration-200 hover:shadow-md hover:border-rose-300">
            ...
            <p className="text-xl sm:text-2xl lg:text-3xl font-semibold text-rose-900">
            ...
            <>
              ...
              <div className="lg:hidden p-4 space-y-4">
                {ledgerEntries.map((entry) => (
                  <div
                    key={entry.periodId}
                    className="border-2 border-indigo-200 rounded-xl p-4 bg-white/80 backdrop-blur-sm hover:shadow-md transition-all"
                  >
                    <div className="mb-3 pb-3 border-b-2 border-indigo-100">
